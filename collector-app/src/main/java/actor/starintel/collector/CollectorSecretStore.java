...
/**
 * Keystore-backed secret storage for the collector's own bearer key and the optional
 * remote transcription key. Secrets never leave this app's private storage unencrypted
 * and must never enter logs or exports.
 */
public final class CollectorSecretStore {
    private static final String KEYSTORE = "AndroidKeyStore";
    private static final String KEY_ALIAS = "star_wireless_secrets";
    private static final String PREFS = "star_wireless_secrets";
    private static final String GCM_TRANSFORMATION = "AES/GCM/NoPadding";
    private static final int GCM_TAG_BITS = 128;

    private final SharedPreferences prefs;

    public CollectorSecretStore(Context context) {
